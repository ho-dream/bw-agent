...
description: 当开始需要在当前工作区之外隔离的功能开发，或在执行实施计划之前使用——创建隔离的 git worktree，支持智能目录选择和安全验证
---
...
**调用方：**
- **brainstorming**（第 4 阶段）— 当设计获批并进入实施时必需
